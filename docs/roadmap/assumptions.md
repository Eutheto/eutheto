...
| OR-Tools | 9.15 | **9.15.6755 source input approved for Phase-03 native build work; production adoption remains K.3-gated** | The generated source contract binds the exact source/protobuf/common-CMake/static-linkage decision to immutable approval evidence `d74be8614150ad8474dd78f59ffe0dc761fd742f`. Finalized Linux and Windows build artifacts now carry validated manifests, exact license/NOTICE payloads, and SPDX 2.3 SBOMs; production packaging and remaining Phase-03 behavior still gate backend availability. Phase 11/12 owns exact release artifacts. [release](https://github.com/google/or-tools/releases/tag/v9.15). |
...
| Gate | Status | Owner/closure evidence |
|---|---|---|
| Exact release/commit | **Source-stage approved: v9.15 at `551ad10d94835c99e5e1e684500d3db398c0e345`, semantic build version `9.15.6755`.** Generated `workers/ortools/source-contract.json` binds approval evidence `docs/roadmap/assumptions.md@d74be8614150ad8474dd78f59ffe0dc761fd742f` for dependency-gated native build work. Finalized Linux and Windows build artifacts close the installed manifest/license/SBOM build gate; packaging and remaining K.3 behavior still block production adoption. | Target matrix runs `33577785073`, `33582692427`, `33587339469`, `33590499388`, and exact-protobuf-source run `33595985834`; finalized Windows worker run `33674502944` at `69c4e34` |
...
| Worker SBOM/license manifest | **Build-artifact gate passed; packaged exact-artifact review remains open.** Deterministic manifests inventory and hash the worker, runtime closure, license corpus, NOTICE, and SPDX 2.3 SBOM; validation binds source/protobuf/protocol approvals, target-specific CMake evidence, capabilities, linkage, and runtime files. | Commit `69c4e34`: local Nix artifact `/nix/store/f3r29mdpgpqmi0f5lbc606yqx75md6a0-eutheto-ortools-worker-0.1.0` validated with manifest digest `6c85e599895f60efb44583b843b9eb610f147ca5daf30709fd1d57324f889cd7`; hosted Windows run `33674502944` passed native tests, recursive dependency checks, finalization, and three manifest validations with digest `f4fb1815a26d21fa087d2733a18144b4da9b5c06be46aa95e2cc2a497e5f2c3f`; portable run `33674507619` passed the full target matrix at the same commit. Phase 11/12 owns exact assembled-bundle inspection, signing, and publication. |
