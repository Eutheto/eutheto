...
| Tauri/Vue/Tailwind/shadcn/Reka/Lucide pins | **Phase-04 explanation foundation locked:** Tauri 2.11.5, Vue 3.5.42, Tailwind CSS and `@tailwindcss/vite` 4.3.3, shadcn-vue 2.8.2, Reka UI 2.10.4, and `@lucide/vue` 1.37.0; the direct support set is class-variance-authority 0.7.1, clsx 2.1.1, tailwind-merge 3.6.0, and tw-animate-css 1.4.0 | `apps/desktop/package.json`, `pnpm-lock.yaml`, generated license/SBOM inventories, Phase-04 explanation component and visual smoke evidence; Phase 06 owns any justified extension |
