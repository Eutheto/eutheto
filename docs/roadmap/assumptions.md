...
| OR-Tools | 9.15 | **9.15.6755 source selection approved for generated source-contract binding; production adoption remains K.3-gated** | The exact source/protobuf/common-CMake/static-linkage decision is approved by the K.3 evidence below. The generated source contract must cite this immutable ledger revision before native build work consumes it. Installed manifest/SBOM/license payload, production packaging, and remaining Phase-03 behavior still gate backend availability; Phase 11/12 owns exact release artifacts. [release](https://github.com/google/or-tools/releases/tag/v9.15). |
...
| Gate | Status | Owner/closure evidence |
|---|---|---|
| Exact release/commit | **Source-stage decision approved: v9.15 at `551ad10d94835c99e5e1e684500d3db398c0e345`, semantic build version `9.15.6755`.** An approved generated source contract may bind this ledger revision for dependency-gated native build work; installed manifest/SBOM, packaging, and remaining K.3 behavior still block production adoption. | Target matrix runs `33577785073`, `33582692427`, `33587339469`, `33590499388`, and exact-protobuf-source run `33595985834` |
