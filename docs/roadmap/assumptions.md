...
| Gate | Status | Owner/closure evidence |
|---|---|---|
| Exact release/commit | **Pinned candidate: v9.15 at `551ad10d94835c99e5e1e684500d3db398c0e345`; all four MVP target source builds and pre-pin primitive benchmarks pass, while callback, linkage, manifest, and remaining K.3 gates still block adoption** | Phase 3 target matrix runs `33577785073` and `33582692427`; official release assets identify semantic build version `9.15.6755` |
