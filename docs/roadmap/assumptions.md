...
| Tauri/Vue/Tailwind/shadcn/Reka/Lucide pins | **Tauri/Vue values recorded; minimum Tailwind/shadcn/Reka/Lucide foundation selected for Phase 04 and lock open until that implementation**, including mandatory direct `@pinia/colada` 1.4.2, `@vue/compiler-sfc` 3.5.42, `@vue/devtools-api` 8.2.1 and `@lucide/vue` 1.37.0 | Existing Cargo/pnpm locks; Phase 04 minimum explanation-UI foundation lock and smoke; Phase 06 extension |
