...
# Seating `core` boundary

This directory reserves the future Rust domain-pack implementation for the official **seating arrangement planning** pack. It contains no implementation, manifest, public format, or compatibility promise in Phase 00.
