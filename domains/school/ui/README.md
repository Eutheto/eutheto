...
This directory reserves future domain-specific presentation components and view logic for the official **school timetable and block planning** pack. It contains no implementation, manifest, public format, or compatibility promise in Phase 00.
