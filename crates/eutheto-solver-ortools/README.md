...
conjunction, implication, equivalence, one-of, cardinality-range, and integer linear
comparison constraints,
rejecting every unsupported planning feature rather than omitting it. The crate
