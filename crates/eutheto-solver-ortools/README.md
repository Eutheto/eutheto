...
candidate decoding, truthful bounded progress conversion, exact adapter timing
and quality evidence aggregation, and the isolated worker executable identity,
launch, and single-session protocol supervisor.
