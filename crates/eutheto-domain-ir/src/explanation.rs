...
use super::{
    ...
    MAX_VERIFICATION_RULES, MetricId, MetricValue, OptimizationDirection, Ordering, PackId,
    RequestId, Rfc3339Timestamp, RuleEvaluation, RuleId, RunInputV1, RunManifestV1,
    RunTerminalOutcomeV1, ScenarioId, ScenarioSnapshotId, ScoreCategoryId, ScoreLevelId,
    ScoreVector, Serialize, SolutionId, SolveRunId, SolveStatus, VerificationFactId,
...
pub struct CounterfactualRequestSemanticsV1 {
    ...
    pub condition_checksum: String,
    /// Positive total budget shared by compilation and solve work.
...
pub enum CounterfactualConclusionV1 {
    ...
    /// No verified candidate was found before a limit terminal outcome.
