use crate::{
    BackendCandidate, BackendSolveOutcome, BackendTerminationReason, CapabilityMatrix,
    CompatibilityReport, ModelCostEstimate, RequiredFeature, SolverApiLimits, SolverDescriptor,
    SupportFeatureId,
};
